...
const Navigation: React.FC<NavigationProps> = ({
      ...
      .map((group) => {
        const visibleItems = group.items.filter((item) => {
          ...
          if (item.id === "curriculum") {
            ...
            return canAccessView("curriculum") || visibleSubItems.length > 0;
          }
  ...
  const hasVisibleCurriculumSubItems = visibleCurriculumSubItems.length > 0;
                    ...
                    <li key={item.id}>
                      <div className='relative w-full'>
                        ...
                        >
                          ...
                          {(isFileMaintenance ||
                            (isCurriculum && hasVisibleCurriculumSubItems) ||
                            isTransaction ||
                            isReport) &&
                            item.hasSubmenu && (
