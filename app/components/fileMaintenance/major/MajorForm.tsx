...
const MajorForm: React.FC<MajorFormProps> = ({
  ...
  const initialFormData = useRef<Partial<Major>>(
    major || {
      code: "",
      name: "",
      description: "",
    ...
    >
      ...
      >
        ...
        <ConfirmationModal
          ...
          title='Save Changes'
          message={`Are you sure you want to save changes to "${formData.name || major?.name}"?`}
          description='The major information will be updated with the new details.'
