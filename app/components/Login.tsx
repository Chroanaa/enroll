      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-500 to-purple-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-12">
          ...
          <div className="text-center max-w-md">
            ...
            <h1 className="text-4xl font-bold mb-4">EduAnalytics</h1>
            <p className="text-xl text-blue-100 mb-6">Enrollment System Dashboard</p>
            <p className="text-lg text-blue-50 leading-relaxed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla facilisi. Sed at
              urna in urna gravida tincidunt. Curabitur euismod, sapien ac blandit semper,
              odio lacus cursus enim, vel viverra justo erat nec nisl.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">EduAnalytics</h1>
            <p className="text-gray-600">Enrollment System Dashboard</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Sign in to access your enrollment dashboard</p>
            </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border-2 border-gray-200 rounded-lg text-gray-700 font-medium hover:border-gray-300 hover:bg-gray-50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
