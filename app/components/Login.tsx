      ...
      <div className='hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-500 to-purple-600 relative overflow-hidden'>
        ...
        <div className='relative z-10 flex flex-col justify-center items-center text-white p-12'>
          ...
          <div className='text-center max-w-md'>
            ...
            <h1 className='text-4xl font-bold mb-4'>EduFlow</h1>
            <p className='text-xl text-blue-100 mb-6'>
              Enrollment System Dashboard
            </p>
            <p className='text-lg text-blue-50 leading-relaxed'>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla
              facilisi. Sed at urna in urna gravida tincidunt. Curabitur
              euismod, sapien ac blandit semper, odio lacus cursus enim, vel
              viverra justo erat nec nisl.
            </p>
          </div>
        </div>
      </div>
